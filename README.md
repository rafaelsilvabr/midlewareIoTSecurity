...
|-----------------------------|---------------------|-----------------------|------------------|-------------------|--------------------------|--------------|
| # Middleware de Comunicação Segura para IoT

Este projeto implementa um middleware de comunicação segura para dispositivos IoT, permitindo a escolha de diferentes estratégias de criptografia com base nas necessidades de segurança e nas características dos dispositivos.
...
2. Personalize o código do middleware de acordo com as necessidades do seu projeto.
3. Execute o middleware para estabelecer a comunicação segura com dispositivos IoT.
...
| Limitados           | Alta/Baixa            | 256+ bits        | Sim               | Sim                      | Moderada     |
| AES                         | Suficientes         | Baixa                 | 128/192/256 bits| Não               | Sim                      | Baixa        |
| TLS/SSL                     | Suficientes         | Baixa                 | 2048+ bits       | Sim               | Sim                      | Alta         |
| Token-Based Authentication  | Todos               | Baixa                 | Não aplicável    | Sim               | Não                      | Baixa        |
| API Keys                    | Todos               | Baixa                 | 128+ bits        | Não               | Não                      | Baixa        |
